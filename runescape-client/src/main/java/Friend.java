...
public class Friend extends Buddy {
	...
	int compareToFriend(Friend var1) {
		if (super.world == Client.worldId && Client.worldId != var1.world) { // L: 12
			...
			return 1;
		} else if (this.field4932 && !var1.field4932) { // L: 16
			return -1;
		} else if (!this.field4932 && var1.field4932) { // L: 17
			return 1;
		} else if (this.field4933 && !var1.field4933) { // L: 18
			return -1;
		} else if (!this.field4933 && var1.field4933) { // L: 19
			return 1;
		} else {
