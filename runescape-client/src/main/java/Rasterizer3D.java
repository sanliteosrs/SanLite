...
public class Rasterizer3D {
	...
	public static class298 field2876;
	@ObfuscatedName("aj")
	@ObfuscatedSignature(
		descriptor = "Lky;"
	)
	static class280 field2874;
	@ObfuscatedName("av")
	@ObfuscatedSignature(
		descriptor = "Lky;"
	)
	static final class280 field2881;
	@ObfuscatedName("ab")
	@ObfuscatedSignature(
		descriptor = "Lky;"
	)
	static final class280 field2882;

	static {
		Rasterizer3D_colorPalette = new int[65536]; // L: 6
		field2875 = new int[512]; // L: 7
		field2880 = new int[2048]; // L: 8
		Rasterizer3D_sine = new int[2048]; // L: 9
		Rasterizer3D_cosine = new int[2048]; // L: 10

		int var0;
		for (var0 = 1; var0 < 512; ++var0) { // L: 17
			field2875[var0] = 32768 / var0; // L: 18
		}

		for (var0 = 1; var0 < 2048; ++var0) { // L: 20
			field2880[var0] = 65536 / var0; // L: 21
		}
		...
		field2876 = new class298(); // L: 27
		field2881 = new class297(field2876); // L: 28
		field2882 = new class299(field2876); // L: 29
		field2874 = field2881; // L: 30
	} // L: 31

	@ObfuscatedName("aq")
	public static void method5325(boolean var0) {
		if (var0 && Rasterizer2D.field5435 != null) { // L: 38
			field2874 = field2882; // L: 39
		} else {
			field2874 = field2881; // L: 42
		}
	...
	public static void method5309(TextureLoader var0) {
		field2876.Rasterizer3D_textureLoader = var0; // L: 47
	} // L: 48
	...
	@ObfuscatedName("an")
	static int method5251() {
		return field2876.field3196; // L: 112
	}

	@ObfuscatedName("aj")
	static int method5246() {
		return field2876.field3197; // L: 116
	}

	@ObfuscatedName("av")
	static int method5252() {
		return field2876.field3188; // L: 120
	}

	@ObfuscatedName("ab")
	static int method5254() {
		return field2876.field3201; // L: 124
	}

	@ObfuscatedName("ai")
	static int method5255() {
		return field2876.field3190; // L: 128
	}

	@ObfuscatedName("ae")
	static int method5271() {
		return field2876.field3189; // L: 132
	}

	@ObfuscatedName("au")
	public static int method5257() {
		return field2876.field3184; // L: 136
	}

	@ObfuscatedName("ah")
	static int method5258() {
		return field2876.field3198; // L: 140
	}

	@ObfuscatedName("az")
	public static void method5259(int[] var0, int var1, int var2, float[] var3) {
		if (var3 == null && field2874 == field2882) { // L: 144
			field2874 = field2881; // L: 145
		}

		field2874.method5360(var0, var1, var2, var3); // L: 147
	} // L: 148
	...
	static void Rasterizer3D_setClip(int var0, int var1, int var2, int var3) {
		field2876.field3198 = var2 - var0; // L: 155
		field2876.field3199 = var3 - var1; // L: 156
		method5262(); // L: 157
		if (field2876.Rasterizer3D_rowOffsets.length < field2876.field3199) { // L: 158
			field2876.Rasterizer3D_rowOffsets = new int[ModeWhere.method7432(field2876.field3199)]; // L: 159
		}

		int var4 = var0 + Rasterizer2D.Rasterizer2D_width * var1; // L: 161

		for (int var5 = 0; var5 < field2876.field3199; ++var5) { // L: 162
			field2876.Rasterizer3D_rowOffsets[var5] = var4; // L: 163
	...
	public static void method5262() {
		field2876.method5946(); // L: 169
	} // L: 170

	@ObfuscatedName("ay")
	public static void method5307(int var0, int var1) {
		int var2 = field2876.Rasterizer3D_rowOffsets[0]; // L: 173
		int var3 = var2 / Rasterizer2D.Rasterizer2D_width; // L: 174
		int var4 = var2 - var3 * Rasterizer2D.Rasterizer2D_width; // L: 175
		field2876.method5947(var0, var4, var1, var3); // L: 176
	} // L: 177

	@ObfuscatedName("ao")
	public static void method5326(int var0, int var1, int var2) {
		field2876.method5948(var0, var1, var2); // L: 180
	} // L: 181

	@ObfuscatedName("aa")
	static void method5265(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11) {
		field2874.vmethod5953(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11); // L: 184
	} // L: 185

	@ObfuscatedName("as")
	public static void method5266(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9) {
		field2874.vmethod5959(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9); // L: 188
	} // L: 189
	...
	static void method5267(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21) {
		field2874.vmethod5961(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21); // L: 192
	} // L: 193
	...
	static void method5268(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17, int var18, int var19, int var20, int var21) {
		field2874.vmethod5968(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15, var16, var17, var18, var19, var20, var21); // L: 196
	} // L: 197
	...
	static void method5269(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, int var10, int var11, byte var12, byte var13, byte var14, byte var15) {
		field2874.method5363(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13, var14, var15); // L: 200
	} // L: 201
	...
	static void method5270(int var0, int var1, int var2, int var3, int var4, int var5, float var6, float var7, float var8, int var9, byte var10, byte var11, byte var12, byte var13) {
		field2874.method5397(var0, var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, var13); // L: 204
	} // L: 205
}
