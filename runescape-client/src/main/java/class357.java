...
public class class357 {
	...
	static {
		field3816 = new short[]{6798, 8741, 25238, 4626, 4550}; // L: 4
		...
		field3818 = new short[]{-10304, 9104, -1, -1, -1}; // L: 12
	...
	static int method6854(int var0, Script var1, boolean var2) {
		if (var0 == 7463) { // L: 5168
			boolean var3 = Interpreter.Interpreter_intStack[--class130.Interpreter_intStackSize] == 1; // L: 5169
			class168.method3509(var3); // L: 5170
			return 1; // L: 5171
		} else {
			return 2; // L: 5173
		}
