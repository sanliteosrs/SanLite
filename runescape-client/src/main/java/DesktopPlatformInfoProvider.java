...
public class DesktopPlatformInfoProvider implements class507 {
	...
	public class506 get() {
		byte var1;
		if (HealthBarUpdate.field1270.startsWith("win")) { // L: 16
			var1 = 1;
		} else if (HealthBarUpdate.field1270.startsWith("mac")) { // L: 17
			var1 = 2;
		} else if (HealthBarUpdate.field1270.startsWith("linux")) { // L: 18
			var1 = 3;
		} else {
			var1 = 4; // L: 19
		}
		...
		return new class506(var1, var29, var7, var8, this.field5086, this.field5083, this.field5088, false, var10, var11, var12, 0, var13, var14, var15, var16, 0, 0, 0, 0, var17, var18, var23, 0, "", "", var27); // L: 100
	}
	...
	void method8924(String var1) {
		if (var1.startsWith("1.")) { // L: 104
			this.method8917(var1); // L: 105
		} else {
			this.method8918(var1); // L: 108
		}
	...
	void method8917(String var1) {
		...
		try {
			this.field5086 = Integer.parseInt(var2[1]); // L: 115
			var2 = var2[2].split("_"); // L: 116
			this.field5083 = Integer.parseInt(var2[0]); // L: 117
			this.field5088 = Integer.parseInt(var2[1]); // L: 118
	...
	void method8918(String var1) {
		...
		try {
			this.field5086 = Integer.parseInt(var2[0]); // L: 126
			this.field5083 = Integer.parseInt(var2[1]); // L: 127
			this.field5088 = Integer.parseInt(var2[2]); // L: 128
