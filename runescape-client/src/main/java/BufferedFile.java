...
public class BufferedFile {
	...
	public void write(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (var3 <= this.writeBuffer.length) { // L: 159
				...
				if (this.offset + (long)var3 > this.readBufferOffset && this.offset + (long)var3 <= this.readBufferOffset + (long)this.readBufferLength) { // L: 175
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) { // L: 203
			...
			this.fileOffset += (long)(this.writeBufferLength * 2011049699) * 2105706187L; // L: 209
