...
@ObfuscatedName("ky")
public abstract class class280 extends Rasterizer2D {
	@ObfuscatedName("ai")
	...
	class280(class298 var1) {
		this.field2900 = false; // L: 8
		this.field2897 = false; // L: 9
		this.field2901 = Rasterizer3D.Rasterizer3D_colorPalette; // L: 20
		this.field2905 = var1; // L: 21
	} // L: 22

	@ObfuscatedName("aq")
	void method5360(int[] var1, int var2, int var3, float[] var4) {
		Rasterizer2D.method9902(var1, var2, var3, var4); // L: 25
	} // L: 26
	...
	void method5363(int var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9, int var10, int var11, int var12, byte var13, byte var14, byte var15, byte var16) {
		var10 = method5361(var10, var13, var14, var15, var16); // L: 53
		var11 = method5361(var11, var13, var14, var15, var16); // L: 54
		var12 = method5361(var12, var13, var14, var15, var16); // L: 55
		this.vmethod5953(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12); // L: 56
	} // L: 57
	...
	void method5397(int var1, int var2, int var3, int var4, int var5, int var6, float var7, float var8, float var9, int var10, byte var11, byte var12, byte var13, byte var14) {
		int var15 = method5361(var10, var11, var12, var13, var14); // L: 60
		var10 = this.field2901[var15]; // L: 61
		this.vmethod5959(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10); // L: 62
	} // L: 63
	...
	static int method5361(int var0, byte var1, byte var2, byte var3, byte var4) {
		int var5 = var0 >> 10 & 63; // L: 29
		int var6 = var0 >> 7 & 7; // L: 30
		int var7 = var0 & 127; // L: 31
		int var8 = var4 & 255; // L: 32
		if (var1 != -1) { // L: 33
			var5 += var8 * (var1 - var5) >> 7; // L: 34
		}

		if (var2 != -1) { // L: 36
			var6 += var8 * (var2 - var6) >> 7; // L: 37
		}

		if (var3 != -1) { // L: 39
			var7 += var8 * (var3 - var7) >> 7; // L: 40
		}

		return (var5 << 10 | var6 << 7 | var7) & 65535; // L: 42
	}

	@ObfuscatedName("ag")
	static final int method5403(int var0, int var1) {
		var1 = (var0 & 127) * var1 >> 7; // L: 46
		if (var1 < 2) { // L: 47
			var1 = 2;
		} else if (var1 > 126) { // L: 48
			var1 = 126;
		}

		return (var0 & 65408) + var1; // L: 49
	}

	@ObfuscatedName("ai")
	static final int method5369() {
		return field2906; // L: 71
	}
	...
	static void method5371(int var0) {
		int var1 = var0 * 140; // L: 79
		method5370(var1); // L: 80
	} // L: 81
}
