...
public class WorldMapScaleHandler {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "1489701215"
	)
	void method5109(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		if (var7 != 0 && this.pixelsPerTile != 0 && this.tileTemplates != null) { // L: 14
			var8 = this.method5148(var8, var7); // L: 15
			var7 = this.method5111(var7); // L: 16
	...
	static final void method5152(Actor var0) {
		int var1 = Math.max(1, var0.field1253 - Client.cycle); // L: 4605
		int var2 = var0.field1242 * 128 + var0.field1194 * 64; // L: 4606
		int var3 = var0.field1244 * 128 + var0.field1194 * 64; // L: 4607
		var0.x += (var2 - var0.x) / var1; // L: 4608
		var0.field1191 += (var3 - var0.field1191) / var1; // L: 4609
		var0.field1264 = 0; // L: 4610
		var0.field1257 = var0.field1248; // L: 4611
	} // L: 4612
}
