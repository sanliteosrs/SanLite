...
public class VorbisSample extends Node {
	...
	float[] method1122(int var1) {
		...
		var2.method1168(this.field375[var1], 0); // L: 147
		this.field367 = new float[field355]; // L: 148
		var2.method1166(); // L: 149
		int var3 = var2.method1178(class168.iLog(field361.length - 1)); // L: 150
		boolean var4 = field360[var3]; // L: 151
		int var5 = var4 ? field355 : field354; // L: 152
		boolean var6 = false; // L: 153
		boolean var7 = false; // L: 154
		if (var4) { // L: 155
			var6 = var2.method1166() != 0; // L: 156
			var7 = var2.method1166() != 0; // L: 157
		}
		...
		int var11;
		if (var4 && !var6) { // L: 163
			var9 = (var5 >> 2) - (field354 >> 2); // L: 164
			var10 = (field354 >> 2) + (var5 >> 2); // L: 165
			var11 = field354 >> 1; // L: 166
		} else {
			var9 = 0; // L: 169
			var10 = var8; // L: 170
			var11 = var5 >> 1; // L: 171
		...
		int var14;
		if (var4 && !var7) { // L: 176
			var12 = var5 - (var5 >> 2) - (field354 >> 2); // L: 177
			var13 = (field354 >> 2) + (var5 - (var5 >> 2)); // L: 178
			var14 = field354 >> 1; // L: 179
		} else {
			var12 = var8; // L: 182
			var13 = var5; // L: 183
			var14 = var5 >> 1; // L: 184
		...
		VorbisMapping var15 = field350[field361[var3]]; // L: 186
		int var16 = var15.field335; // L: 187
		int var17 = var15.field336[var16]; // L: 188
		class59 var18 = field357[var17].method780(var2); // L: 189
		boolean var19 = !var18.method1161(); // L: 190

		int var20;
		for (var20 = 0; var20 < var15.field337; ++var20) { // L: 191
			class46 var45 = field370[var15.field334[var20]]; // L: 192
			float[] var47 = this.field367; // L: 193
			var45.method898(var47, var5 >> 1, var19, var2); // L: 194
		}

		if (var18.method1161()) { // L: 197
			var16 = var15.field335; // L: 198
			int var10000 = var15.field336[var16]; // L: 199
			var18.method1158(this.field367, var5 >> 1); // L: 200
		}

		int var21;
		int var22;
		if (!var18.method1161()) { // L: 203
			...
			var21 = var5 >> 2; // L: 208
			var22 = var5 >> 3; // L: 209
			float[] var23 = this.field367; // L: 210
			...
			float[] var43 = var4 ? field371 : field368; // L: 213
			float[] var25 = var4 ? field372 : field359; // L: 214
			float[] var26 = var4 ? field373 : field362; // L: 215
			int[] var27 = var4 ? field358 : field374; // L: 216
			...
			var28 = class168.iLog(var5 - 1); // L: 237
			...
			for (var48 = var12; var48 < var13; ++var48) { // L: 312
				...
				var57 = this.field367; // L: 314
				var57[var48] *= (float)Math.sin(1.5707963267948966D * (double)var30 * (double)var30);
			}
		}

		float[] var44 = null; // L: 317
		if (this.field364 > 0) { // L: 318
			var21 = var5 + this.field364 >> 2; // L: 319
			var44 = new float[var21]; // L: 320
			int var46;
			if (!this.field366) { // L: 321
				for (var22 = 0; var22 < this.field365; ++var22) { // L: 322
					var46 = var22 + (this.field364 >> 1); // L: 323
					var44[var22] += this.field363[var46]; // L: 324
				}
			}

			if (var18.method1161()) { // L: 327
				for (var22 = var9; var22 < var5 >> 1; ++var22) { // L: 328
					var46 = var44.length - (var5 >> 1) + var22; // L: 329
					var44[var46] += this.field367[var22]; // L: 330
				}
			}
		}

		float[] var56 = this.field363; // L: 334
		this.field363 = this.field367; // L: 335
		this.field367 = var56; // L: 336
		this.field364 = var5; // L: 337
		this.field365 = var13 - (var5 >> 1); // L: 338
		this.field366 = !var18.method1161(); // L: 339
		return var44; // L: 340
	}
	...
	RawSound toRawSound(int[] var1) {
		if (var1 != null && var1[0] <= 0) { // L: 368
			...
			if (this.samples == null) { // L: 369
				this.field364 = 0; // L: 370
				this.field363 = new float[field355]; // L: 371
				this.samples = new byte[this.sampleCount]; // L: 372
				this.field377 = 0; // L: 373
				this.field378 = 0; // L: 374
			}

			for (; this.field378 < this.field375.length; ++this.field378) { // L: 376 391
				if (var1 != null && var1[0] <= 0) { // L: 377
					return null;
				}

				float[] var2 = this.method1122(this.field378); // L: 378
				if (var2 != null) { // L: 379
					int var3 = this.field377; // L: 380
					...
					this.field377 = var3; // L: 389
				}
			}

			this.field363 = null; // L: 393
			byte[] var7 = this.samples; // L: 394
			this.samples = null; // L: 395
			return new RawSound(this.sampleRate, var7, this.start, this.end, this.field351); // L: 396
		}
	}
	...
	static void method1113(byte[] var0) {
		class60 var1 = field353; // L: 78
		var1.method1168(var0, 0); // L: 79
		field354 = 1 << var1.method1178(4); // L: 80
		field355 = 1 << var1.method1178(4); // L: 81
		...
		for (var2 = 0; var2 < 2; ++var2) { // L: 82
			var3 = var2 != 0 ? field355 : field354; // L: 83
			var4 = var3 >> 1; // L: 84
			var5 = var3 >> 2; // L: 85
			var6 = var3 >> 3; // L: 86
			...
			int var11 = class168.iLog(var6 - 1); // L: 103

			for (int var12 = 0; var12 < var6; ++var12) { // L: 104
				var16[var12] = class83.method2340(var12, var11);
			}

			if (var2 != 0) { // L: 105
				field371 = var13; // L: 106
				field372 = var14; // L: 107
				field373 = var15; // L: 108
				field358 = var16; // L: 109
			} else {
				field368 = var13; // L: 112
				field359 = var14; // L: 113
				field362 = var15; // L: 114
				field374 = var16; // L: 115
			}
		}

		var2 = var1.method1178(8) + 1; // L: 118
		field347 = new VorbisCodebook[var2]; // L: 119

		for (var3 = 0; var3 < var2; ++var3) { // L: 120
			field347[var3] = new VorbisCodebook();
		}

		var3 = var1.method1178(6) + 1; // L: 122

		for (var4 = 0; var4 < var3; ++var4) { // L: 123
			var1.method1178(16);
		}

		var3 = var1.method1178(6) + 1; // L: 125
		field357 = new VorbisFloor[var3]; // L: 126

		for (var4 = 0; var4 < var3; ++var4) { // L: 127
			field357[var4] = new VorbisFloor();
		}

		var4 = var1.method1178(6) + 1; // L: 128
		field370 = new class46[var4]; // L: 129

		for (var5 = 0; var5 < var4; ++var5) { // L: 130
			field370[var5] = new class46();
		}

		var5 = var1.method1178(6) + 1; // L: 131
		field350 = new VorbisMapping[var5]; // L: 132

		for (var6 = 0; var6 < var5; ++var6) { // L: 133
			field350[var6] = new VorbisMapping();
		}

		var6 = var1.method1178(6) + 1; // L: 134
		field360 = new boolean[var6]; // L: 135
		field361 = new int[var6]; // L: 136

		for (int var7 = 0; var7 < var6; ++var7) { // L: 137
			field360[var7] = var1.method1166() != 0; // L: 138
			var1.method1178(16); // L: 139
			var1.method1178(16); // L: 140
			field361[var7] = var1.method1178(8); // L: 141
		}
