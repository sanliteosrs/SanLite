			...
			if (var1.offset < var2) { // L: 40
				...
				if (var4 != null && var4.hasCleanName()) { // L: 55
					...
					if (var6 != var11.world) { // L: 91
						var11.int2 = ++this.field4919 - 1; // L: 92
						if (var11.world == -1 && var6 == 0) { // L: 93
							var11.int2 = -(var11.int2 * 415892275) * 1329967099;
						}
					...
					var11.field4932 = var9; // L: 97
					var11.field4933 = var10; // L: 98
					continue; // L: 99
				}
