...
public class PacketBuffer extends Buffer {
	...
	static {
		field5358 = new int[]{0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535, 131071, 262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727, 268435455, 536870911, 1073741823, Integer.MAX_VALUE, -1}; // L: 7
	}
	...
	public boolean method9504() {
		int var1 = super.array[super.offset] - this.isaacCipher.method10147() & 255; // L: 31
	...
	public int readBits(int var1) {
		...
		for (this.bitIndex += var1; var1 > var3; var3 = 8) { // L: 54 55 58
			var4 += (super.array[var2++] & field5358[var3]) << var1 - var3; // L: 56
			var1 -= var3; // L: 57
		}
		...
		if (var3 == var1) { // L: 60
			...
			var4 += super.array[var2] >> var3 - var1 & field5358[var1]; // L: 61
		}
	...
	public int method9502(int var1) {
