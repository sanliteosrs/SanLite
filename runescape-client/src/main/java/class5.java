...
public class class5 implements class2 {
	...
	class5(class8 var1) {
		this.field15 = this.method24(); // L: 14
	} // L: 15

	@ObfuscatedName("aq")
	boolean method20(int var1, String var2, long var3) {
		byte[] var5 = this.method28(var2, var3); // L: 18
		return method19(var5) >= var1; // L: 19
	}
	...
	byte[] method28(String var1, long var2) {
		...
		this.field15.reset(); // L: 58

		try {
			this.field15.update(var4.toString().getBytes("UTF-8")); // L: 60
		} catch (UnsupportedEncodingException var6) { // L: 62
			var6.printStackTrace(); // L: 63
		}

		return this.field15.digest(); // L: 65
	}
