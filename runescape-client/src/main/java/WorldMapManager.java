...
public final class WorldMapManager {
	...
	public void load(AbstractArchive var1, String var2, boolean var3) {
		if (!this.loadStarted) { // L: 42
			...
			int var4 = var1.getGroupId(WorldMapCacheName.field2740.name); // L: 48
			int var5 = var1.getFileId(var4, var2); // L: 49
			Buffer var6 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2740.name, var2)); // L: 50
			Buffer var7 = new Buffer(var1.takeFileByNames(WorldMapCacheName.field2738.name, var2)); // L: 51
			...
			if (var1.isValidFileName(WorldMapCacheName.field2739.name, var2)) { // L: 97
				byte[] var20 = var1.takeFileByNames(WorldMapCacheName.field2739.name, var2); // L: 98
				this.compositeTextureSprite = class199.method3813(var20); // L: 99
			}
	...
	public final void drawTiles(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
		...
		float[] var12 = Rasterizer2D.field5435; // L: 115
		...
		Rasterizer3D.method5259(var9, var10, var11, var12); // L: 134
		...
		for (int var22 = var14.x; var22 < var14.x + var14.width; ++var22) { // L: 139
			for (int var23 = var14.y; var23 < var14.height + var14.y; ++var23) { // L: 140
				this.regions[var22][var23].method4702(var5 + var19 * (this.regions[var22][var23].regionX * 64 - var20) / 64, var8 - var19 * (this.regions[var22][var23].regionY * 64 - var21 + 64) / 64, var19); // L: 141
			}
		}
	...
	public final void drawElements(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, HashSet var9, HashSet var10, int var11, int var12, boolean var13) {
		...
		for (var19 = var14.x; var19 < var14.width + var14.x; ++var19) { // L: 152
			for (var20 = var14.y; var20 < var14.y + var14.height; ++var20) { // L: 153
				...
				this.regions[var19][var20].method4712(var5 + var16 * (this.regions[var19][var20].regionX * 64 - var17) / 64, var8 - var16 * (this.regions[var19][var20].regionY * 64 - var18 + 64) / 64, var16, var9); // L: 157
			}
		}
		...
		if (!this.loaded) { // L: 201
			...
			for (int var17 = var12.x; var17 < var12.width + var12.x; ++var17) { // L: 209
				for (int var18 = var12.y; var18 < var12.y + var12.height; ++var18) { // L: 210
					List var19 = this.regions[var17][var18].method4733(var5 + var14 * (this.regions[var17][var18].regionX * 64 - var15) / 64, var8 + var6 - var14 * (this.regions[var17][var18].regionY * 64 - var16 + 64) / 64, var14, var9, var10); // L: 211
	...
	public int method4819() {
		return this.mapAreaData.method4693(); // L: 258
	}
	...
	public static void method4829() {
		SpotAnimationDefinition.SpotAnimationDefinition_cached.clear(); // L: 128
		SpotAnimationDefinition.Widget_cachedFonts.clear(); // L: 129
	} // L: 130
	...
	static final void method4845(int var0, int var1, int var2) {
		SceneTilePaint.method5915(class20.field91, var0, var1, var2); // L: 9208
	} // L: 9209
}
