...
public class DirectByteArrayCopier extends AbstractByteArrayCopier {
	...
	@ObfuscatedSignature(
		...
		garbageValue = "1211882338"
	)
	public static int method7035(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		...
		float var24 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class131.field1544; // L: 19
		if (var7 <= var24) { // L: 20
			return -1; // L: 21
		} else {
			...
			if (var1 == 0) { // L: 31
				...
				class426 var11 = new class426(var9, var1); // L: 50
				...
				int var14 = method7035(var12, var1 - 1, var2, false, var4, false, var21); // L: 56
				if (var14 == -1) { // L: 57
					return 0; // L: 58
				} else {
					...
					for (int var20 = 0; var20 <= var14; ++var20) { // L: 65
						...
						if (var20 == 0) { // L: 67
							var16 = var2; // L: 68
							var18 = WorldMapLabel.method5003(var9, var1, var2); // L: 69
						...
						var17 = WorldMapLabel.method5003(var9, var1, var19); // L: 83
						if (var15) { // L: 84
							var15 = false; // L: 85
							...
							var6[var10++] = class68.method1249(var11, var16, var19, 0.0F); // L: 95
